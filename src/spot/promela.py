########################################################
"""
This code is copied as it from here : https://github.com/MengGuo/P_MAS_TG/blob/master/P_MAS_TG/promela.py

All credit goes to the author for the github repo.

This code is used to interpret an output in Neverclaim format in Promela which is the output format for many tools like:
1. ltl2ba
2. Spot (if you use the flag "--spin")
3. Spin - A model checker software
"""
########################################################
import re
